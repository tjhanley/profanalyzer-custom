...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Rakefile", "History.txt", "Manifest.txt", "PostInstall.txt", "lib/profanalyzer.rb", "script/destroy", "script/generate", "test/test_helper.rb", "test/test_profanalizer.rb"]
  s.homepage = %q{https://github.com/tjhanley/profanalizer-custom}
